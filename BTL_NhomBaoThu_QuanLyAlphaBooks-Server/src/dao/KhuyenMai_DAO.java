...
public class KhuyenMai_DAO extends UnicastRemoteObject implements IKhuyenMai {
	...
	public KhuyenMai getKhuyenMaiViaSanPhamAutoApply(int maSanPham) throws RemoteException {
		try {
			List<KhuyenMai> result = em.createNamedQuery("KhuyenMai.getKhuyenMaiViaSanPhamAutoApply", KhuyenMai.class)
					.setParameter("sanPhamID", maSanPham)
					.setMaxResults(1) // Giới hạn 1 kết quả
					.getResultList();
