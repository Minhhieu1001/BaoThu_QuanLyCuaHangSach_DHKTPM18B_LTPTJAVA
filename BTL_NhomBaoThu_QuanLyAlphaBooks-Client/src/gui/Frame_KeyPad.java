...
public class Frame_KeyPad extends JFrame {
    ...
    private void initComponents() {
        ...
        btnNumber1 = new JButton();
        btnNumber2 = new JButton();
        btnNumber3 = new JButton();
        btnNumber4 = new JButton();
        btnNumber5 = new JButton();
        btnNumber6 = new JButton();
        btnNumber7 = new JButton();
        jButton8 = new JButton();
        btnNumber8 = new JButton();
        btnNumber9 = new JButton();
        btnNumber0 = new JButton();
        btnBackspace = new JButton();
        btnEnter = new JButton();
        btnDot = new JButton();
        btnClear = new JButton();
        btnNumber11 = new JButton();
