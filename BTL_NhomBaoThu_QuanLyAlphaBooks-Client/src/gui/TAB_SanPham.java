...
//
    ...
    private void initComponents() {
        ...
        jPanel_List_SanPham = new JPanel();
        filler1 = new Box.Filler(new Dimension(0, 0), new Dimension(30, 0), new Dimension(32767, 32767));
        jPanel_SanPhamKhac = new JPanel();
        jPanel7 = new JPanel();
        ...
        jPanel_List_SanPham1 = new JPanel();
        filler2 = new Box.Filler(new Dimension(0, 0), new Dimension(30, 0), new Dimension(32767, 32767));

        setLayout(new java.awt.BorderLayout());

        jTabbedPane1.setMaximumSize(new Dimension(2147483647, 2147483647));
        jTabbedPane1.setMinimumSize(new Dimension(500, 200));
        jTabbedPane1.setPreferredSize(new Dimension(500, 700));

        jPanel_Sach.setMinimumSize(new Dimension(16, 500));
        jPanel_Sach.setPreferredSize(new Dimension(1280, 500));
        jPanel_Sach.setLayout(new java.awt.BorderLayout());

        jPanel4.setAutoscrolls(true);
        jPanel4.setFocusable(false);

        jButton_ThemSanPham.setBackground(new Color(15, 145, 239));
        jButton_ThemSanPham.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jButton_ThemSanPham.setForeground(new Color(255, 255, 255));
        ...
        jButton_Import.setBackground(new Color(204, 204, 204));
        jButton_Import.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jButton_Import.setForeground(new Color(255, 255, 255));
        ...
        jPanel10.setPreferredSize(new Dimension(265, 88));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel4.setText("Nhà xuất bản");
        jLabel4.setPreferredSize(new Dimension(85, 22));
        ...
        jPanel18.setPreferredSize(new Dimension(250, 88));
        ...
        jPanel9.setPreferredSize(new Dimension(100, 88));

        jButton_TimKiem.setBackground(new Color(15, 145, 239));
        ...
        jPanel12.setPreferredSize(new Dimension(100, 88));

        jButton_refresh.setBackground(new Color(15, 145, 239));
        jButton_refresh.setForeground(new Color(255, 255, 255));
        ...
        jScrollPane1.setBackground(new Color(255, 204, 204));
        jScrollPane1.setMaximumSize(new Dimension(2147483647, 2147483647));
        jScrollPane1.setMinimumSize(new Dimension(16, 20));
        jScrollPane1.setPreferredSize(new Dimension(50, 50));

        jPanel_List_SanPham.setMaximumSize(new Dimension(2147483647, 2147483647));
        jPanel_List_SanPham.setMinimumSize(new Dimension(500, 500));
        jPanel_List_SanPham.setName(""); // NOI18N
        jPanel_List_SanPham.setPreferredSize(new Dimension(500, 500));
        jPanel_List_SanPham.setLayout(new BoxLayout(jPanel_List_SanPham, BoxLayout.Y_AXIS));
        jScrollPane1.setViewportView(jPanel_List_SanPham);

        jPanel_Sach.add(jScrollPane1, java.awt.BorderLayout.CENTER);

        filler1.setBackground(new Color(242, 242, 242));
        jPanel_Sach.add(filler1, java.awt.BorderLayout.LINE_END);

        jTabbedPane1.addTab("Sách", jPanel_Sach);

        jPanel_SanPhamKhac.setMinimumSize(new Dimension(16, 500));
        jPanel_SanPhamKhac.setPreferredSize(new Dimension(1280, 500));
        jPanel_SanPhamKhac.setLayout(new java.awt.BorderLayout());

        jPanel7.setAutoscrolls(true);
        jPanel7.setFocusable(false);

        jButton_Them_SPK.setBackground(new Color(15, 145, 239));
        jButton_Them_SPK.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jButton_Them_SPK.setForeground(new Color(255, 255, 255));
        ...
        jPanel17.setPreferredSize(new Dimension(265, 88));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel8.setText("Thương hiệu");
        jLabel8.setPreferredSize(new Dimension(85, 22));
        ...
        jPanel19.setPreferredSize(new Dimension(250, 88));
        ...
        jPanel20.setPreferredSize(new Dimension(100, 88));

        jButton_TimKiem_SPK.setBackground(new Color(15, 145, 239));
        jButton_TimKiem_SPK.setForeground(new Color(255, 255, 255));
        ...
        jPanel21.setPreferredSize(new Dimension(100, 88));

        jButton_refresh_SPK.setBackground(new Color(15, 145, 239));
        jButton_refresh_SPK.setForeground(new Color(255, 255, 255));
        ...
        jScrollPane2.setBackground(new Color(255, 204, 204));
        jScrollPane2.setMaximumSize(new Dimension(2147483647, 2147483647));
        jScrollPane2.setMinimumSize(new Dimension(16, 20));
        jScrollPane2.setPreferredSize(new Dimension(50, 50));

        jPanel_List_SanPham1.setMaximumSize(new Dimension(2147483647, 2147483647));
        jPanel_List_SanPham1.setMinimumSize(new Dimension(500, 500));
        jPanel_List_SanPham1.setName(""); // NOI18N
        jPanel_List_SanPham1.setPreferredSize(new Dimension(500, 500));
        jPanel_List_SanPham1.setLayout(new BoxLayout(jPanel_List_SanPham1, BoxLayout.Y_AXIS));
        jScrollPane2.setViewportView(jPanel_List_SanPham1);

        jPanel_SanPhamKhac.add(jScrollPane2, java.awt.BorderLayout.CENTER);

        filler2.setBackground(new Color(242, 242, 242));
    ...
    private void jButton_TimKiemActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (timKiem_SapXep.equals("Giá cao nhất")) {
            list = sanPham_BUS.SapXepGiamTheoGia(list);
        }
        else if (timKiem_SapXep.equals("Giá thấp nhất")) {
            list = sanPham_BUS.SapXepTangTheoGia(list);
        }
        else if (timKiem_SapXep.equals("Số lượng tăng")) {
            list = sanPham_BUS.SapXepTangTheoSoLuong(list);
        }
...
//                LocalDate localDate = LocalDate.parse(ngayNhap, formatter);
    ...
    private JPanel jPanel_List_SanPham;
    private JPanel jPanel_List_SanPham1;
    private JPanel jPanel_Sach;
    private JPanel jPanel_SanPhamKhac;
