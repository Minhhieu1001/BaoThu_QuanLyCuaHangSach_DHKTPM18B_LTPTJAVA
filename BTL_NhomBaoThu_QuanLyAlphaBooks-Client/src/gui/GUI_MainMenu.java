...
public class GUI_MainMenu extends JFrame {
    ...
    public GUI_MainMenu() {
        ...
        ultilities.ImageProcessing.scaleImageFitToLabel(lblLogo, new ImageIcon(this.getClass().getResource("/img/logo/alphabooks-logo.png")));
    ...
    private void initComponents() {
        ...
        btnTabBanHang = new JButton();
        btnTabSanPham = new JButton();
        btnTabKhuyenMai = new JButton();
        btnTabThongKe = new JButton();
        btnTabNhanVien = new JButton();
        btnTabKhachHang = new JButton();
        btnTabNhaCungCap = new JButton();
        btnTabDangXuat = new JButton();
        btnTabGuide = new JButton();
        ...
        getContentPane().add(jPanel4, BorderLayout.PAGE_START);

        jPanel6.setLayout(new BorderLayout());

        jPannelSplit.setDividerSize(4);
        jPannelSplit.setForeground(new Color(255, 255, 255));
        ...
        btnTabBanHang.setBackground(new Color(15, 145, 239));
        btnTabBanHang.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnTabBanHang.setForeground(new Color(255, 255, 255));
        btnTabBanHang.setIcon(
            ultilities.ImageProcessing.resizeIcon(new ImageIcon(getClass().getResource("/img/icon/ico-banhang.png"))
        ...
        btnTabSanPham.setForeground(new Color(15, 102, 165));
        btnTabSanPham.setIcon(
            ultilities.ImageProcessing.resizeIcon(new ImageIcon(getClass().getResource("/img/icon/ico-sanpham.png"))
                , sizeIconBar, sizeIconBar)
        );
        ...
        btnTabKhuyenMai.setForeground(new Color(15, 102, 165));
        btnTabKhuyenMai.setIcon(
            ultilities.ImageProcessing.resizeIcon(new ImageIcon(
    ...
    btnTabThongKe.setForeground(new Color(15, 102, 165));
    btnTabThongKe.setIcon(ultilities.ImageProcessing.resizeIcon(new ImageIcon(
    ...
    btnTabNhanVien.setForeground(new Color(15, 102, 165));
    btnTabNhanVien.setIcon(ultilities.ImageProcessing.resizeIcon(new ImageIcon(
    ...
    btnTabKhachHang.setForeground(new Color(15, 102, 165));
    btnTabKhachHang.setIcon(ultilities.ImageProcessing.resizeIcon(new ImageIcon(
    ...
    btnTabNhaCungCap.setForeground(new Color(15, 102, 165));
    btnTabNhaCungCap.setIcon(ultilities.ImageProcessing.resizeIcon(new ImageIcon(
    ...
    btnTabDangXuat.setForeground(new Color(15, 102, 165));
    btnTabDangXuat.setIcon(ultilities.ImageProcessing.resizeIcon(new ImageIcon(
    ...
    btnTabGuide.setForeground(new Color(15, 102, 165));
    btnTabGuide.setIcon(ultilities.ImageProcessing.resizeIcon(new ImageIcon(
    ...
    jPanel6.add(jPannelSplit, BorderLayout.CENTER);
    ...
    private void cboUserActionPerformed(ActionEvent evt) {//GEN-FIRST:event_cboUserActionPerformed
        // TODO add your handling code here:
    ...
    public void tabSwitcher(JPanel panelChuyen, Enum_TabMainMenu tabMoi, JButton btnTab) {
        ...
        if (panelRight.getComponentCount() > 0) {
            ...
            btnTabSanPham.setForeground(new Color(15, 102, 165));
            isFocusTab.setForeground(new Color(15, 102, 165));
        ...
        isFocusTab = btnTab;
        isFocusTab.setBackground(new Color(15, 145, 239));
        isFocusTab.setForeground(new Color(255, 255, 255));
    ...
    private JButton btnTabBanHang;
    private JButton btnTabDangXuat;
    private JButton btnTabGuide;
    private JButton btnTabKhachHang;
    private JButton btnTabKhuyenMai;
    private JButton btnTabNhaCungCap;
    private JButton btnTabNhanVien;
    private JButton btnTabSanPham;
    private JButton btnTabThongKe;
