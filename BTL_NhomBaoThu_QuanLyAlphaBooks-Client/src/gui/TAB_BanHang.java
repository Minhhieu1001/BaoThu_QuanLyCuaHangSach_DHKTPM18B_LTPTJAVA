...
public class TAB_BanHang extends JPanel implements MouseListener {
    ...
    public TAB_BanHang() {
        ...
        // Placeholder text
        ((JTextFieldPlaceHolder) txtMaKhachHang).setPlaceholder("Nhập mã KH hoặc SĐT");
        ((JTextFieldPlaceHolder) txtKhuyenMai).setPlaceholder("Nhập mã khuyến mãi");
    ...
    public void setTrangThaiEditor(TAB_HoaDon_EditorMode tt) {
        ...
        if (TAB_HoaDon_EditorMode.XEM_CHI_TIET_HOA_DON == tt) {
            ...
            btnThemSanPham.setIcon(ImageProcessing
                    .resizeIcon(new ImageIcon(getClass().getResource("/img/icon/btn-add.png")), 20, 20));
            btnXoaRongMaSP.setEnabled(false);
            ...
            btnThemSanPham.setIcon(ImageProcessing
                    .resizeIcon(new ImageIcon(getClass().getResource("/img/icon/btn-remove.png")), 20, 20));
...
//                        hoaDonTra.addChiTietHoaDon(ctth);
    ...
    private void initComponents() {
        ...
        tabbedHoaDon = new JPanel();
        tabBanHang_HoaDon_Center = new JPanel();
        jPanel7 = new JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        tblChiTietHoaDon = new JTable();
        tabBanHang_HoaDon_Button = new JPanel();
        ...
        tabBanHang_HoaDon_Right = new JPanel();
        tabBanHang_HoaDon_Right_KhachHang = new JPanel();
        jPanel11 = new JPanel();
        jPanel12 = new JPanel();
        txtMaKhachHang = new JTextFieldPlaceHolder();
        btnKhachHangEnter = new javax.swing.JButton();
        jLabel8 = new javax.swing.JLabel();
        txtDisplayTenKH = new JTextField();
        txtDisplayMaKH = new JTextField();
        jLabel9 = new javax.swing.JLabel();
        tabBanHang_HoaDon_Right_GiamGia = new JPanel();
        jPanel15 = new JPanel();
        jPanel16 = new JPanel();
        txtKhuyenMai = new JTextFieldPlaceHolder();
        btnKhuyenMaiEnter = new javax.swing.JButton();
        jLabel12 = new javax.swing.JLabel();
        txtDisplayChuongTrinhKM = new JTextField();
        txtDisplayMaGiamGia = new JTextField();
        jLabel13 = new javax.swing.JLabel();
        lblTrangThaiApDungKM = new javax.swing.JLabel();
        panel_TongTien = new JPanel();
        lblTongTien = new javax.swing.JLabel();
        txtValueTongTien = new JTextField();
        lblChietKhau = new javax.swing.JLabel();
        txtValueChietKhau = new JTextField();
        lblThanhTien = new javax.swing.JLabel();
        txtValueThanhTien = new JTextField();
        txtValueTongThue = new JTextField();
        lblThue = new javax.swing.JLabel();
        btnThanhToan = new javax.swing.JButton();
        btnKeyPad = new javax.swing.JButton();
        tabbedDanhSachHoaDon = new JPanel();
        jPanel1 = new JPanel();
        jPanel2 = new JPanel();
        ...
        txt_DSHD_GiaTriTu = new JTextField();
        txt_DSHD_GiaTriDen = new JTextField();
        jLabel14 = new javax.swing.JLabel();
        jLabel15 = new javax.swing.JLabel();
        jLabel16 = new javax.swing.JLabel();
        txt_DSHD_MaHoaDon = new JTextField();
        txt_DSHD_MaKH = new JTextField();
        txt_DSHD_MaNV = new JTextField();
        ...
        jPanel7.setBorder(BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        jPanel7.setLayout(new java.awt.BorderLayout());

        tblChiTietHoaDon.setModel(tblModelCTHD = new DefaultTableModel(
                new Object [][] {
            ...
            Class[] types = new Class [] {
                    Object.class, String.class, String.class, Double.class, Object.class, Integer.class, Object.class, String.class, Double.class, Object.class
            };
        ...
        btnThemSanPham.setIcon(
                ImageProcessing.resizeIcon(new ImageIcon(getClass().getResource("/img/icon/btn-add.png")), 20,20)
        );
        ...
        btnXoaRongMaSP.setIcon(
                ImageProcessing.resizeIcon(new ImageIcon(getClass().getResource("/img/icon/btn-delete.png")), 15,20)
        );
        ...
        tabBanHang_HoaDon_Right_KhachHang.setBorder(BorderFactory.createTitledBorder("Khách hàng"));
        ...
        btnKhachHangEnter.setIcon(
                ImageProcessing.resizeIcon(new ImageIcon(getClass().getResource("/img/icon/btn-search.png")), 20,20)
        );
        ...
        tabBanHang_HoaDon_Right_GiamGia.setBorder(BorderFactory.createTitledBorder("Khuyến mãi"));
        ...
        btnKhuyenMaiEnter.setIcon(
                ImageProcessing.resizeIcon(new ImageIcon(getClass().getResource("/img/icon/btn-tap.png")), 20,20)
        );
        ...
        jPanel2.setBorder(BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        ...
        jPanel8.setBorder(BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        ...
        btn_DSHD_ThanhToan.setIcon(ImageProcessing.resizeIcon(new ImageIcon(getClass().getResource("/img/icon/btn-xulyhoadoncu.png")), 25,25));
        ...
        btn_DSHD_InHD.setIcon(ImageProcessing.resizeIcon(new ImageIcon(getClass().getResource("/img/icon/btn-print.png")), 25,25));
        ...
        btn_DSHD_XemChiTiet.setIcon(ImageProcessing.resizeIcon(new ImageIcon(getClass().getResource("/img/icon/btn-viewdetails.png")), 25,25));
        ...
        btn_DSHD_DoiTraHoaDon.setIcon(ImageProcessing.resizeIcon(new ImageIcon(getClass().getResource("/img/icon/btn-doitrahoadon.png")), 25,25));
        ...
        btn_DSHD_HuyHoaDon.setIcon(ImageProcessing.resizeIcon(new ImageIcon(getClass().getResource("/img/icon/btn-delete-white.png")), 25,25));
        ...
        jTable2.setModel(tblHoaDon = new DefaultTableModel(
                new Object [][] {
    ...
    private void jTabbedMouseClicked(MouseEvent evt) {//GEN-FIRST:event_jTabbedMouseClicked
    ...
    private void tblHoaDonMouseClicked(MouseEvent evt) {//GEN-FIRST:event_tblHoaDonMouseClicked
        // TODO add your handling code here:
        // TODO add your handling code here:
    ...
    private void btn_DSHD_HuyHoaDonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btn_DSHD_HuyHoaDonActionPerformed
        // TODO add your handling code here:
    ...
    private void btn_DSHD_DoiTraHoaDonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btn_DSHD_DoiTraHoaDonActionPerformed
        // TODO add your handling code here:
    ...
    private void btn_DSHD_XemChiTietActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btn_DSHD_XemChiTietActionPerformed
        // TODO add your handling code here:
        if (jTable2.getSelectedRow() < 0) {
            ErrorMessage.showMessageWithFocusTextField("Lỗi", "Chưa chọn hoá đơn cần xử lý!", txt_DSHD_GiaTriTu);
            return;
    ...
    private void btn_DSHD_ThanhToanActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btn_DSHD_ThanhToanActionPerformed
        // TODO add your handling code here:
        if (jTable2.getSelectedRow() < 0) {
            ErrorMessage.showMessageWithFocusTextField("Lỗi", "Chưa chọn hoá đơn cần xử lý!", txt_DSHD_GiaTriTu);
            return;
    ...
    private void btn_DSHD_xoaRongActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btn_DSHD_xoaRongActionPerformed
        // TODO add your handling code here:
    ...
    private void btn_DSHD_taiLaiActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btn_DSHD_taiLaiActionPerformed
        // TODO add your handling code here:
        loadTableHoaDon(hoaDon_BUS.getDanhSachHoaDon());

    }//GEN-LAST:event_btn_DSHD_taiLaiActionPerformed

    private void btn_DSHD_SearchActionPerformed(ActionEvent evt) {
    ...
    private void txt_DSHD_MaHoaDonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_txt_DSHD_MaHoaDonActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_DSHD_MaHoaDonActionPerformed

    private void btnKeyPadActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnKeyPadActionPerformed
        // TODO add your handling code here:
        new Frame_KeyPad(this, txtKhuyenMai).setVisible(true);
    }//GEN-LAST:event_btnKeyPadActionPerformed

    private void btnThanhToanActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        // TODO add your handling code here:
    ...
    private void btnKhuyenMaiEnterActionPer(ActionEvent evt) {//GEN-FIRST:event_btnKhuyenMaiEnterActionPer
        // TODO add your handling code here:
    ...
    private void txtKhuyenMaiActionPerformed(ActionEvent evt) {//GEN-FIRST:event_txtKhuyenMaiActionPerformed
        // TODO add your handling code here:
        btnKhuyenMaiEnter.doClick();
    }//GEN-LAST:event_txtKhuyenMaiActionPerformed

    private void jTextFieldClicked(MouseEvent evt) {//GEN-FIRST:event_jTextFieldClicked
        // TODO add your handling code here:
        lastClicked = (JTextField) evt.getSource();
    }//GEN-LAST:event_jTextFieldClicked

    private void btnKhachHangEnterAP(ActionEvent evt) {//GEN-FIRST:event_btnKhachHangEnterAP
        // TODO add your handling code here:
        try {
    ...
    private void txtMaKhachHangActionPerformed(ActionEvent evt) {//GEN-FIRST:event_txtMaKhachHangActionPerformed
        // TODO add your handling code here:
        btnKhachHangEnter.doClick();
    }//GEN-LAST:event_txtMaKhachHangActionPerformed

    private void btnXoaRongMaSPActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnXoaRongMaSPActionPerformed
        // TODO add your handling code here:
        clearTextAndFocus(txtMaSanPham);
    }//GEN-LAST:event_btnXoaRongMaSPActionPerformed

    private void btnAddSanPhamActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnAddSanPhamActionPerformed
        // TODO add your handling code here:
        int tempPos = -1;
    ...
    private void btnCancelHDActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnCancelHDActionPerformed
        // TODO add your handling code here:
        // TODO add your handling code here:
        switch (trangThaiEditor) {
    ...
    private void btnHangChoActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnHangChoActionPerformed
        // TODO add your handling code here:
        if (hoaDon.getListChiTietHoaDon().size() < 1) {
            ErrorMessage.showMessageWithFocusTextField("Cảnh báo",
    ...
    private void btn_DSHD_InHDActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btn_DSHD_InHDActionPerformed
        // TODO add your handling code here:
        if (jTable2.getSelectedRow() < 0) {
    ...
    private void btn_DSHD_LoadHoaDonChoActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btn_DSHD_LoadHoaDonChoActionPerformed
        // TODO add your handling code here:
...
//        //}
    ...
    private void btnKhachHangEnterActionPerformed(ActionEvent evt) {// GEN-FIRST:event_btnKhachHangEnterActionPerformed
        // TODO add your handling code here:
    ...
    private JPanel tabBanHang_HoaDon_Button;
    private JPanel tabBanHang_HoaDon_Center;
    private JPanel tabBanHang_HoaDon_Right;
    private JPanel tabBanHang_HoaDon_Right_GiamGia;
    private JPanel tabBanHang_HoaDon_Right_KhachHang;
    private JPanel tabbedDanhSachHoaDon;
    private JPanel tabbedHoaDon;
    private JTable tblChiTietHoaDon;
    private JTextField txtDisplayChuongTrinhKM;
    private JTextField txtDisplayMaGiamGia;
    private JTextField txtDisplayMaKH;
    private JTextField txtDisplayTenKH;
    private JTextField txtKhuyenMai;
    private JTextField txtMaKhachHang;
    private JTextField txtMaSanPham;
    private JTextField txtValueChietKhau;
    private JTextField txtValueThanhTien;
    private JTextField txtValueTongThue;
    private JTextField txtValueTongTien;
    private com.toedter.calendar.JDateChooser txt_DSHD_DenNLHD;
    private JTextField txt_DSHD_GiaTriDen;
    private JTextField txt_DSHD_GiaTriTu;
    private JTextField txt_DSHD_MaHoaDon;
    private JTextField txt_DSHD_MaKH;
    private JTextField txt_DSHD_MaNV;
