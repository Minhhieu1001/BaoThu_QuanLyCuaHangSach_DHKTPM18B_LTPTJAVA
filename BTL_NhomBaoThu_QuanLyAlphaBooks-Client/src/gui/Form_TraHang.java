...
public class Form_TraHang extends JFrame {
	...
	public Form_TraHang(HoaDon x, JFrame y, TAB_BanHang tab, HoaDonTra z) {
		...
		// Thiết lập combo box cho cột "Chọn lý do trả"
		...
		comboBox.setSelectedItem("Không có lý do"); // Giá trị mặc định
		...
		DefaultCellEditor cellEditor = new DefaultCellEditor(comboBox) {
			...
			public boolean stopCellEditing() {
				...
				if (row >= 0 && row < hoaDonTra.getListChiTietHoaDon().size()) {
					String selectedItem = (String) getCellEditorValue();
					System.out.println("Updating liDoTraHang for row " + row + ": " + selectedItem); // Log để debug
					try {
						hoaDonTra.getListChiTietHoaDon().get(row).setLiDoTraHang(selectedItem);
						// Cập nhật giá trị trong bảng
						tblModelTraHang.setValueAt(selectedItem, row, 3);
					} catch (IllegalArgumentException ex) {
						JOptionPane.showMessageDialog(null, "Lỗi khi cập nhật lý do trả hàng: " + ex.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE);
						return false;
					}
				}
		...
		jTable1.getColumnModel().getColumn(3).setCellEditor(cellEditor);

		// Hiển thị danh sách ChiTietTraHang
	...
	private void initComponents() {
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						jPanel5Layout.createSequentialGroup().addContainerGap()
								.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
										...
										.addComponent(lblTraKhach, javax.swing.GroupLayout.Alignment.LEADING,
												javax.swing.GroupLayout.PREFERRED_SIZE, 192,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addContainerGap(23, Short.MAX_VALUE)));
		jPanel5Layout.setVerticalGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						jPanel5Layout.createSequentialGroup().addContainerGap().addComponent(jLabel22)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(lblCanThanhToan)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(jLabel24)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(lblTraKhach, javax.swing.GroupLayout.PREFERRED_SIZE, 27,
										javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addGap(9, 9, 9).addGroup(jPanel2Layout
						...
						.addGroup(jPanel2Layout.createSequentialGroup()
								.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(lblTongTien, javax.swing.GroupLayout.PREFERRED_SIZE, 254,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 155,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(lblMaHoaDon, javax.swing.GroupLayout.PREFERRED_SIZE, 204,
												javax.swing.GroupLayout.PREFERRED_SIZE))
						...
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
								jPanel2Layout.createSequentialGroup().addContainerGap()
										.addComponent(jLabel3, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(lblMaHoaDon, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addGap(14, 14, 14)
										.addComponent(jLabel6, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(lblTongTien, javax.swing.GroupLayout.PREFERRED_SIZE, 25,
												javax.swing.GroupLayout.PREFERRED_SIZE)));
		...
		btnBackThanhToan.addActionListener(new ActionListener() {
		...
		btnThanhToanHoanTat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
		...
		jTable1.setModel(tblModelTraHang = new DefaultTableModel(new Object[][] {},
				new String[] { "STT", "Tên sản phẩm", "Số lượng", "Chọn lí do trả" }) {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
								layout.createSequentialGroup().addComponent(jSeparator1).addGap(18, 18, 18))
						.addGroup(layout.createSequentialGroup()
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
										.addGroup(layout.createSequentialGroup()
												.addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, 198,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGap(70, 70, 70).addComponent(jPanel5,
														javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE))
										.addComponent(jPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, 489,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 489,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addContainerGap(26, Short.MAX_VALUE))))
				.addGroup(layout.createSequentialGroup().addGap(116, 116, 116).addComponent(jLabel1).addGap(0, 0,
						Short.MAX_VALUE)));
	...
	private void formWindowClosing(java.awt.event.WindowEvent evt) {// GEN-FIRST:event_formWindowClosing
		...
		if (ErrorMessage.showConfirmDialogYesNo("Xác nhận thoát",
				"Hoá đơn này chưa được thanh toán, bạn đã chắc chắn muốn thoát?")) {
			closeFormThanhToan();
		}
	}// GEN-LAST:event_formWindowClosing

	private void btnThanhToanHoanTatActionPerformed(ActionEvent evt) {
		// Hủy hóa đơn gốc
		hoaDon_BUS.cancelHoaDon(hoaDon);

		// Kiểm tra và gán lý do trả hàng mặc định nếu thiếu
		for (int i = 0; i < hoaDonTra.getListChiTietHoaDon().size(); i++) {
			ChiTietTraHang ctth = hoaDonTra.getListChiTietHoaDon().get(i);
			String liDo = (String) tblModelTraHang.getValueAt(i, 3); // Lấy giá trị từ bảng
			if (liDo == null || liDo.trim().isEmpty()) {
				liDo = "Không có lý do";
			}
			try {
				ctth.setLiDoTraHang(liDo);
			} catch (IllegalArgumentException ex) {
				JOptionPane.showMessageDialog(null, "Lỗi khi cập nhật lý do trả hàng cho sản phẩm " + ctth.getSanPham().getSanPhamID() + ": " + ex.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE);
				return;
			}
		}

		// Thiết lập thông tin cho hóa đơn trả và hóa đơn gốc
		...
		// Lưu danh sách chi tiết trả hàng
		...
		// Nếu còn sản phẩm trong hóa đơn gốc, tạo hóa đơn mới
	...
	private void btnBackThanhToanActionPerformed(ActionEvent evt) {// GEN-FIRST:event_btnBackThanhToanActionPerformed
		// TODO add your handling code here:
		if (ErrorMessage.showConfirmDialogYesNo("Xác nhận thoát",
				"Hoá đơn này chưa được thanh toán, bạn đã chắc chắn muốn thoát?")) {
			closeFormThanhToan();
