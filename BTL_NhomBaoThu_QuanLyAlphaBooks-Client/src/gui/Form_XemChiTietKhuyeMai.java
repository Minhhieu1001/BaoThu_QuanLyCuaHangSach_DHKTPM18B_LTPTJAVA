...
public class Form_XemChiTietKhuyeMai extends JFrame {
    ...
    private void loadData() {
        // Kiểm tra danh sách khuyenMais
        if (khuyenMais != null && !khuyenMais.isEmpty()) {
            lblMaKM.setText(khuyenMais.get(0).getCodeKhuyenMai());
            lblTenKM.setText(khuyenMais.get(0).getTenKhuyenMai());
        } else {
            lblMaKM.setText("N/A");
            lblTenKM.setText("N/A");
        }

        // Lấy ngày tạo và xử lý trường hợp null
        Date ngayTao = chiTietKhuyenMai_BUS.getNgayTao(maKM);
        String ngayTaoFormatted = (ngayTao != null) ? GetToDay.sdf.format(ngayTao) : "N/A";

        // Thêm dữ liệu vào bảng
        int stt = 1;
        if (sanPhams != null && !sanPhams.isEmpty()) {
            for (SanPham sp : sanPhams) {
                tableModel.addRow(new Object[] {stt++, sp.getSanPhamID(), sp.getTenSanPham(), ngayTaoFormatted});
            }
        } else {
            // Có thể hiển thị thông báo nếu không có sản phẩm
            tableModel.addRow(new Object[] {1, "N/A", "Không có sản phẩm", ngayTaoFormatted});
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new Color(14, 102, 165));
        ...
        jLabel2.setForeground(new Color(14, 102, 165));
