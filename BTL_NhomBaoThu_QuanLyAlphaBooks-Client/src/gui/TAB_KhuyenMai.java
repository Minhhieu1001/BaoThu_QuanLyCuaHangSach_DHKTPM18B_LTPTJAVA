...
public class TAB_KhuyenMai extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        checkBoxSelectChoTatCa = new JCheckBox();
        jPanel12 = new javax.swing.JPanel();
        TimMaSanPham = new JTextField();
        ...
        txt_CTTKM_GiaTriTu = new JTextField();
        txt_CTTKM_GiaTriDen = new JTextField();
        jLabel14 = new javax.swing.JLabel();
        jLabel15 = new javax.swing.JLabel();
        jLabel16 = new javax.swing.JLabel();
        txt_CTTKM_MaKhuyenMai = new JTextField();
        txt_CTTKM_TenKM = new JTextField();
        ...
        txt_CTTKM_KiemTraVoucher = new JTextField();
        ...
        btnLuu.setBackground(new Color(85, 182, 83));
        btnLuu.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnLuu.setForeground(new Color(255, 255, 255));
        btnLuu.setIcon(new ImageIcon(getClass().getResource("/img/icon/km_save.png"))); // NOI18N
        ...
        btnHuy.setBackground(new Color(239, 162, 162));
        btnHuy.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnHuy.setForeground(new Color(255, 255, 255));
        btnHuy.setIcon(new ImageIcon(getClass().getResource("/img/icon/icon-huyKM.png"))); // NOI18N
        ...
        btnTimKiem.setIcon(new ImageIcon(getClass().getResource("/img/icon/icon-addKM.png"))); // NOI18N
        ...
        btnTimKiemKhuyenMai.setBackground(new Color(15, 145, 239));
        btnTimKiemKhuyenMai.setIcon(new ImageIcon(getClass().getResource("/img/icon/icon-search.png"))); // NOI18N
        ...
        tableKM.setModel(tableModel = new DefaultTableModel(
            ...
            Class[] types = new Class [] {
                Integer.class, Object.class, Object.class, Object.class, Double.class, Object.class, Object.class, Double.class, Integer.class, Integer.class, Object.class
            };
        ...
        jPanel23.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(204, 204, 204)));
        ...
        btn_CTTKM_TimKiem.setBackground(new Color(15, 145, 239));
        btn_CTTKM_TimKiem.setForeground(new Color(255, 255, 255));
        ...
        btn_CTTKM_TaiLai.setBackground(new Color(15, 145, 239));
        btn_CTTKM_TaiLai.setForeground(new Color(255, 255, 255));
        ...
        btn_CTTKM_CapNhat.setBackground(new Color(85, 182, 83));
        btn_CTTKM_CapNhat.setForeground(new Color(255, 255, 255));
        ...
        btn_CTTKM_XoaRong.setBackground(new Color(15, 145, 239));
        btn_CTTKM_XoaRong.setForeground(new Color(255, 255, 255));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(204, 204, 204)));
        ...
        table_DSCTTKM.setModel(tableModelDSCTTKM = new DefaultTableModel(
            new Object [][] {
	...
	private void comboboxApDungItemStateChanged(ItemEvent evt) {// GEN-FIRST:event_comboboxApDungItemStateChanged
	...
	private void btn_CTTKM_TimKiemActionPerformed(java.awt.event.ActionEvent evt) throws ParseException {// GEN-FIRST:event_btn_CTTKM_TimKiemActionPerformed
		...
		if (dayStartUtil != null) {
			start = new Date(dayStartUtil.getTime());
		}

		if (dayEndUtil != null) {
			end = new Date(dayEndUtil.getTime());
		}
    ...
    private void cbb_CTTKM_SXGiaTriItemStateChanged(ItemEvent evt) {//GEN-FIRST:event_cbb_CTTKM_SXGiaTriItemStateChanged
        // TODO add your handling code here:
    ...
    private void cbb_CTTKM_DonGiaItemStateChanged(ItemEvent evt) {//GEN-FIRST:event_cbb_CTTKM_DonGiaItemStateChanged
        // TODO add your handling code here:
    ...
    private void txtMaKMKeyReleased(KeyEvent evt) {//GEN-FIRST:event_txtMaKMKeyReleased
        // TODO add your handling code here:
	...
	private void txtDonHangTuKeyTyped(KeyEvent evt) {// GEN-FIRST:event_txtDonHangTuKeyTyped
    ...
    private void txtDonHangTuKeyReleased(KeyEvent evt) {//GEN-FIRST:event_txtDonHangTuKeyReleased
        // TODO add your handling code here:
    	try {
    ...
    private void txtMucGiamGiaKeyReleased(KeyEvent evt) {//GEN-FIRST:event_txtMucGiamGiaKeyReleased
        // TODO add your handling code here:
    	char c = evt.getKeyChar();
		if (!Character.isDigit(c) && c != KeyEvent.VK_BACK_SPACE) {
			evt.consume();
    ...
    private void txtMucGiamGiaKeyTyped(KeyEvent evt) {//GEN-FIRST:event_txtMucGiamGiaKeyTyped
        // TODO add your handling code here:
    	try {
    ...
    private void txtTenKMKeyReleased(KeyEvent evt) {
        handleKeyReleased();
    }
    ...
    private JTextField TimMaSanPham;
    ...
    private JCheckBox checkBoxSelectChoTatCa;
    ...
    private JTextField txtDonHangTu;
    ...
    private JTextField txtTimKMTheoMa;
    private JTextField txt_CTTKM_GiaTriDen;
    private JTextField txt_CTTKM_GiaTriTu;
    private JTextField txt_CTTKM_KiemTraVoucher;
    private JTextField txt_CTTKM_MaKhuyenMai;
    ...
    private JTextField txt_CTTKM_TenKM;
