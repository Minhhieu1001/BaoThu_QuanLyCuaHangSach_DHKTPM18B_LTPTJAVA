...
public class GUI_Login extends JFrame implements ActionListener {
	...
	public GUI_Login() {
		...
		ImageProcessing.scaleImageFitToLabel(lblLogo,
				ImageProcessing.generateImageIcon(GUI_Login.class.getResource("/img/logo/alphabooks-logo.png")));
		...
		JLabel lblDesignedBy = new JLabel(" Nhóm Báo Thủ - Application Development ");
