...
public class Form_XemChiTietHDT extends JFrame {
    ...
    public Form_XemChiTietHDT(String maHoaDon) {
        ...
        // Lấy thông tin HoaDonTra
        HoaDonTra z = hoaDonTra_BUS.getHoaDonByID(new HoaDonTra(maHoaDon));
        if (z == null) {
        ...
        // Hiển thị trực tiếp danh sách ChiTietTraHang mà không qua HoaDonTra
        for (int i = 0; i < chiTietList.size(); i++) {
            ChiTietTraHang ctth = chiTietList.get(i);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(tblModelTraHang = new DefaultTableModel(
            new Object [][] {
            },
            new String [] {
