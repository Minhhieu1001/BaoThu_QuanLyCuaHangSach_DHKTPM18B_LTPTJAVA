...
public class SanPham_BUS implements ISanPham {
	...
	@Override
	public List<SanPham> SapXepTangTheoGia(List<SanPham> list) {
		try {
			return sanPham_DAO.SapXepTangTheoGia(list);
		} catch (RemoteException e) {
			e.printStackTrace();
			return list;
		}
	...
	@Override
	public List<SanPham> SapXepGiamTheoGia(List<SanPham> list) {
		try {
			return sanPham_DAO.SapXepGiamTheoGia(list);
		} catch (RemoteException e) {
			e.printStackTrace();
			return list;
		}
	...
	@Override
	public List<SanPham> SapXepTangTheoSoLuong(List<SanPham> list) {
		try {
			return sanPham_DAO.SapXepTangTheoSoLuong(list);
		} catch (RemoteException e) {
			e.printStackTrace();
			return list;
		}
